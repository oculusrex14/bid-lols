//#region node_modules/.nitro/vite/services/ssr/assets/sites-aEGgv7RZ.js
...
var SITES = {
	...
	culture: {
		...
		description: "Companies bid to showcase their culture, team, and why join us — so the best talent finds them first.",
	...
	bidception: {
		...
		description: "A discovery board for marketing platforms, directories, pay-to-rank tools, newsletter sponsorships, and community boards. Have leftover budget after foundersbid or culturebid? Find the next place to run the same strategy.",
...
//#endregion
export { isSiteId as a, SITE_IDS as i, PORTAL as n, otherSites as o, SITES as r, quoteSwapFee as s, COPY as t };
