...
import { r as isSiteId } from "./sites-DQ1RC7LF.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/board-fns-rrgp09UC.js
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-CGUqDkXs.js
...
var styles_default = "/assets/styles-FWhwH0Er.css";
var APP_NAME = "BID.LOL";
var Route$11 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Two pay-to-rank boards. Foundersbid proves founding teams. Bidception ranks the bid sites. Highest bid ranks first."
			},
			{
				name: "theme-color",
				content: "#0c0b0a"
...
var $$splitComponentImporter$10 = () => import("./routes-DdgQxYZy.mjs");
var Route$10 = createFileRoute("/")({
	loader: () => getPortal(),
	component: lazyRouteComponent($$splitComponentImporter$10, "component")
});
var $$splitComponentImporter$9 = () => import("../_site-BFlnkmvi.mjs");
var Route$9 = createFileRoute("/$site")({
	beforeLoad: ({ params }) => {
		if (!isSiteId(params.site)) throw redirect({ to: "/" });
	},
	component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
var $$splitComponentImporter$8 = () => import("./spec-DQgpcn9x.mjs");
var Route$8 = createFileRoute("/spec")({
	component: lazyRouteComponent($$splitComponentImporter$8, "component"),
	head: () => ({ meta: [{ title: "BID.LOL — Product spec" }] })
});
var $$splitComponentImporter$7 = () => import("../_site-DfmfQZYX.mjs");
var Route$7 = createFileRoute("/$site/")({
	loader: ({ params }) => {
		return getBoard({ data: { site: isSiteId(params.site) ? params.site : "founders" } });
	},
	component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
var $$splitComponentImporter$6 = () => import("./activity-Clcny5jP.mjs");
var Route$6 = createFileRoute("/$site/activity")({ component: lazyRouteComponent($$splitComponentImporter$6, "component") });
var $$splitComponentImporter$5 = () => import("./bid-D1Yo7boP.mjs");
var Route$5 = createFileRoute("/$site/bid")({
	validateSearch: (search) => ({ url: typeof search.url === "string" ? search.url : void 0 }),
	component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
var $$splitComponentImporter$4 = () => import("./rules-BYM2I5Fs.mjs");
var Route$4 = createFileRoute("/$site/rules")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./checkout._orderId-BEWoLnwR.mjs");
var Route$3 = createFileRoute("/$site/checkout/$orderId")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./listing._id-BOjUglqW.mjs");
var Route$2 = createFileRoute("/$site/listing/$id")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./manage._token-Bu7STneS.mjs");
var Route$1 = createFileRoute("/$site/manage/$token")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
...
var SpecRoute = Route$8.update({
	id: "/spec",
	path: "/spec",
	getParentRoute: () => Route$11
});
var SiteIndexRoute = Route$7.update({
	id: "/",
	path: "/",
	getParentRoute: () => SiteRoute
});
var SiteActivityRoute = Route$6.update({
	id: "/activity",
	path: "/activity",
	getParentRoute: () => SiteRoute
});
var SiteBidRoute = Route$5.update({
	id: "/bid",
	path: "/bid",
	getParentRoute: () => SiteRoute
});
var SiteRulesRoute = Route$4.update({
	id: "/rules",
	path: "/rules",
	getParentRoute: () => SiteRoute
});
...
//#endregion
export { getOrder as _, Route$4 as a, Route$7 as c, confirmPayment as d, createBidOrder as f, getManaged as g, getListing as h, Route$3 as i, Route$9 as l, getBoard as m, Route$1 as n, Route$5 as o, createSwapOrder as p, Route$2 as r, Route$6 as s, router_exports as t, Route$10 as u, quoteBid as v, trackClick as y };
