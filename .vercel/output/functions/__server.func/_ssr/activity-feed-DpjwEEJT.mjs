...
import { d as CircleDollarSign, h as ArrowRightLeft } from "../_libs/lucide-react.mjs";
import { i as relativeTime, t as formatUsd } from "./format-DJnXAy3q.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/activity-feed-DpjwEEJT.js
...
function ActivityFeed({ site, items, compact = false }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
		...
		children: items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
			className: compact ? "flex items-start gap-3 border-b border-border py-2.5 last:border-b-0" : "flex items-start gap-3 border-b border-border py-3 last:border-b-0",
