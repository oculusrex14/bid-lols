...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BNyuRKEO.mjs");
...
var manifest = {
	"02ce8b4f5428c757d1b2cc3d317cec158d6fe5fc562ae4ba365a5ce828860e9b": {
		...
		importer: () => import("./board-fns-DhoK1OfS.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CGUqDkXs.mjs").then((n) => n.t),
