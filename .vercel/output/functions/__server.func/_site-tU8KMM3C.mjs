...
import { i as isSiteId, r as SITES, t as COPY } from "./_ssr/sites-BLTVPnCd.mjs";
...
import { T as trackClick, b as getBoard, f as Route$12 } from "./_ssr/router-DcNSb0gZ.mjs";
...
import { t as ActivityFeed } from "./_ssr/activity-feed-DpjwEEJT.mjs";
import { t as TrackSiteView } from "./_ssr/track-site-view-Cycge0Eu.mjs";
...
import { t as SiteFavicon } from "./_ssr/site-favicon-CZfHWoUy.mjs";
import { t as FounderSocials } from "./_ssr/founder-socials-DwHUYlS8.mjs";
import { t as FoundersMasthead } from "./_ssr/founders-masthead-CaAIR3X1.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_site-tU8KMM3C.js
...
function ClaimBox({ site, leaderBidCents }) {
	...
	const headline = site === "founders" ? takesFirst || leaderDollars < 1 ? "Claim #1" : "Bid your rank" : takesFirst || leaderDollars < 1 ? "Outbid the leader" : "Bid your rank";
	const deck = site === "founders" ? takesFirst || leaderDollars < 1 ? "Put the founding team on the first line of the board." : "Rank follows the bid. Highest total stands first." : takesFirst || leaderDollars < 1 ? "Take the meta crown. Highest bid stands first." : "Rank follows the bid. Highest total stands first.";
