/** Site view/visit display scaling. Stored counts stay real; painted figures may scale. */
...
/**
 * Day 1 uses the board's own start factor (random, up to 6×).
 * Steps down linearly every 24h to 1× after 21 days.
 */
